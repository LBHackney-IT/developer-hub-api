...
echo "Renaming all 'DeveloperHubAPI' -> '$PASCAL'"
echo "Renaming all 'DeveloperHubAPI' -> '$CAMEL'"
...
find . -type d -not -path '*/\.git/*' | sed -e "p;s/DeveloperHubAPI/$PASCAL/" | xargs -n2 mv
find . -type d -not -path '*/\.git/*' | sed -e "p;s/DeveloperHubAPI/$CAMEL/" | xargs -n2 mv
# file names
...
find . -type f -not -path '*/\.git/*' | sed -e "p;s/DeveloperHubAPI/$PASCAL/" | xargs -n2 mv
find . -type f -not -path '*/\.git/*' | sed -e "p;s/DeveloperHubAPI/$CAMEL/" | xargs -n2 mv
# strings
find . -type f -not -path '*/\.git/*' -exec sed -i "s/base_api/$SNAKE/g" {} \;
find . -type f -not -path '*/\.git/*' -exec sed -i "s/base-api/$KEBAB/g" {} \;
find . -type f -not -path '*/\.git/*' -exec sed -i "s/DeveloperHubAPI/$PASCAL/g" {} \;
find . -type f -not -path '*/\.git/*' -exec sed -i "s/DeveloperHubAPI/$CAMEL/g" {} \;
